...
(** The [blt_nat] function tests [nat]ural numbers for [l]ess-[t]han,
 ...
 (*beq_nat (n m) means"n=m?"*)
(*ble_nat (n m) means"n <=m?"*)
(*blt_nat(n m) means "n<m"*)
(*blt=ble-beq=(AND ble (NOT beq))*)
...
Proof.
  ...
  intros n m o.
(*universally quantified variables n,m,o*)
  intros H H0 .
(*hypothesis [n = m,m=o] into the context and gives it the (arbitrary)
    name [H,H0]*)
 (*n : nat
m : nat
o : nat
...
(* $Date: 2014-10-02 09:22:16 +0900 (2014年10月02日 (木)) $ *)
