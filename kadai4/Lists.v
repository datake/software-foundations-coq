...
(*c.f surjective_pairubf *)
Theorem sft_swap_is_snd : forall (p : natprod),
...
(*think  just like length_snoc and rev_length*)
...
(*this theorem is used in Theorem distr_rev*)
Theorem snoc_append_from_distr_rev : forall (l1 l2:natlist) (n:nat),
 snoc (l2 ++ l1) n = l2 ++ snoc l1 n.
Proof.
(* 1 subgoal snoc (l2 ++ l1) n = l2 ++ snoc l1 n*)
  intros l1 l2 n.
  induction l2 as [ | m l2'].
(*2 subgoals
______________________________________(1/2)
snoc ([] ++ l1) n = [] ++ snoc l1 n
______________________________________(2/2)
snoc ((m :: l2') ++ l1) n = (m :: l2') ++ snoc l1 n
 *)
  Case "l2 = nil".

    reflexivity.
(* 1 subgoal IHl2' : snoc (l2' ++ l1) n = l2' ++ snoc l1 n*)
   Case "l2 = cons".
(*snoc ((m :: l2') ++ l1) n = (m :: l2') ++ snoc l1 n*)
    simpl.
(*m :: snoc (l2' ++ l1) n = m :: l2' ++ snoc l1 n*)
  rewrite IHl2'.
(*m :: l2' ++ snoc l1 n = m :: l2' ++ snoc l1 n*)
  reflexivity.
Qed.
...
Proof.
(*1 subgoal forall l1 l2 : natlist, rev (l1 ++ l2) = rev l2 ++ rev l1*)
  intros l1 l2.
...
(*rev ([] ++ l2) = rev l2*)
    reflexivity.
(*1 subgoal 
IHl1' : rev (l1' ++ l2) = rev l2 ++ rev l1'
______________________________________(1/1)
rev ((n :: l1') ++ l2) = rev l2 ++ rev (n :: l1')*)
  Case "l1 = cons".
    simpl. 
(*snoc (rev (l1' ++ l2)) n = rev l2 ++ snoc (rev l1') n*)
rewrite -> IHl1'. 
(*snoc (rev l2 ++ rev l1') n = rev l2 ++ snoc (rev l1') n
*)
(* if you dont rewrite Theorem snoc_append_from_distr_rev 
Error: Impossible to unify "rev l2 ++ snoc (rev l1') n" with
 "snoc (rev l2 ++ rev l1') n".*)
    rewrite ->snoc_append_from_distr_rev .
(*rev l2 ++ snoc (rev l1') n = rev l2 ++ snoc (rev l1') n*)
  reflexivity.  Qed.
(*
Theorem distr_rev : forall l1 l2 : natlist,
  rev (l1 ++ l2) = (rev l2) ++ (rev l1).
...
(** Fill in the definition of [beq_natlist], which compares
 ...
 (*failure! head is not the same object.*)
Fixpoint beq_natlist (l1 l2 : natlist) : bool :=
  ...
  |head1 :: l1'=> match l2 with 
            |head2::l2'=> if beq_nat head1 head2 then beq_natlist l1' l2' else false
            |_=>false
            end
end.
...
Example test_beq_natlist2 :   beq_natlist [1;2;3] [1;2;3] = true.
 Proof. reflexivity.  Qed.
Example test_beq_natlist5 :   beq_natlist [1] [2] = false.
 Proof. reflexivity.  Qed.
Example test_beq_natlist4 :   beq_natlist [1;2;3;4] [1;2;4;4] = false.
 Proof. reflexivity.  Qed.
...
(* $Date: 2014-01-29 03:19:45 +0900 (2014年01月29日 (水)) $ *)
